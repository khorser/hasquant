...
underlying :: (HasUnderlying a) => Object s a -> QLE s (Object s (Underlying a))
...
dateDepUnderlying :: (HasDateDependentUnderlying a) => Object s a -> Day -> QLE s (Object s (DateDependentUnderlying a))
...
fairRate :: (SwapWithFixedLeg a) => Object s a -> QLE s Double
fairRate = $(ffiCallX 'fairRate) c_fairRate

fixedLeg :: (SwapWithFixedLeg a) => Object s a -> QLE s (Leg s)
fixedLeg = $(ffiCall 'fixedLeg) c_fixedLeg

fixedLegBPS :: (SwapWithFixedLeg a) => Object s a -> QLE s Double
fixedLegBPS = $(ffiCallX 'fixedLegBPS) c_fixedLegBPS

fixedLegNPV :: (SwapWithFixedLeg a) => Object s a -> QLE s Double
...
fairSpread :: (SwapWithSpread a) => Object s a -> QLE s Double
...
floatingLeg :: (SwapWithFloatingLeg a) => Object s a -> QLE s (Leg s)
floatingLeg = $(ffiCall 'floatingLeg) c_floatingLeg

floatingLegBPS :: (SwapWithFloatingLeg a) => Object s a -> QLE s Double
floatingLegBPS = $(ffiCallX 'floatingLegBPS) c_floatingLegBPS

floatingLegNPV :: (SwapWithFloatingLeg a) => Object s a -> QLE s Double
...
delta :: (OptionWithGreeks a) => Object s a -> QLE s Double
delta = $(ffiCallX 'delta) c_delta

gamma :: (OptionWithGreeks a) => Object s a -> QLE s Double
gamma = $(ffiCallX 'gamma) c_gamma

rho :: (OptionWithGreeks a) => Object s a -> QLE s Double
rho = $(ffiCallX 'rho) c_rho

theta :: (OptionWithGreeks a) => Object s a -> QLE s Double
theta = $(ffiCallX 'theta) c_theta

vega :: (OptionWithGreeks a) => Object s a -> QLE s Double
vega = $(ffiCallX 'vega) c_vega

dividendRho :: (OptionWithGreeks a) => Object s a -> QLE s Double
...
qrho :: (QuantoOption a) => Object s a -> QLE s Double
qrho = $(ffiCallX 'qrho) c_qrho

qvega :: (QuantoOption a) => Object s a -> QLE s Double
qvega = $(ffiCallX 'qvega) c_qvega

qlambda :: (QuantoOption a) => Object s a -> QLE s Double
...
impliedVolatility :: (VolatileOption a) => Object s a
  -> Double -- ^price
...
setPricingEngine :: (Priceable a) => Object s a -> PricingEngine s -> QLE s ()
