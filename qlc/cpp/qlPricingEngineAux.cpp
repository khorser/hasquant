...
PricingEngine* qlMCVarianceSwapEngine1Aux(const char *rngtrait, const boost::shared_ptr<GeneralizedBlackScholesProcess> process, unsigned timeSteps, unsigned timeStepsPerYear, int brownianBridge, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
...
PricingEngine* qlMCHestonHullWhiteEngine1Aux(const char *rngtrait, const boost::shared_ptr<HybridHestonHullWhiteProcess> process, unsigned timeSteps, unsigned timeStepsPerYear, int antitheticVariate, int controlVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCBarrierEngine1Aux(const char *rngtrait, const boost::shared_ptr<GeneralizedBlackScholesProcess> process, unsigned timeSteps, unsigned timeStepsPerYear, int brownianBridge, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, int isBiased, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCDigitalEngine1Aux(const char *rngtrait, const boost::shared_ptr<GeneralizedBlackScholesProcess> x0, unsigned timeSteps, unsigned timeStepsPerYear, int brownianBridge, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCDiscreteArithmeticAPEngine1Aux(const char *rngtrait, const boost::shared_ptr<GeneralizedBlackScholesProcess> process, int brownianBridge, int antitheticVariate, int controlVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCDiscreteArithmeticASEngine1Aux(const char *rngtrait, const boost::shared_ptr<GeneralizedBlackScholesProcess> process, int brownianBridge, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCDiscreteGeometricAPEngine1Aux(const char *rngtrait, const boost::shared_ptr<GeneralizedBlackScholesProcess> process, int brownianBridge, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCEuropeanEngine1Aux(const char *rngtrait, const boost::shared_ptr<GeneralizedBlackScholesProcess> process, unsigned timeSteps, unsigned timeStepsPerYear, int brownianBridge, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCEuropeanGJRGARCHEngine1Aux(const char *rngtrait, const boost::shared_ptr<GJRGARCHProcess> x0, unsigned timeSteps, unsigned timeStepsPerYear, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCEuropeanHestonEngine1Aux(const char *rngtrait, const boost::shared_ptr<HestonProcess> x0, unsigned timeSteps, unsigned timeStepsPerYear, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCHullWhiteCapFloorEngine1Aux(const char *rngtrait, boost::shared_ptr<HullWhite> model, int brownianBridge, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
...
PricingEngine* qlMCPerformanceEngine1Aux(const char *rngtrait, const boost::shared_ptr<GeneralizedBlackScholesProcess> process, int brownianBridge, int antitheticVariate, unsigned requiredSamples, double requiredTolerance, unsigned maxSamples, unsigned seed) {
  if (!strcmp(rngtrait, "PseudoRandom"))
