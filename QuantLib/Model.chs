...
{#fun qlCapHelper as capHelper {fromEnumQuantity `(Word, TimeUnit)'&, withComplexType *`Quote', `IborIndex', `Frequency', withSimpleType* `DayCounter', `Bool', `YieldTermStructure', `CalibrationErrorType', preErrorCheck- `String' errorCheck*-} -> `BlackCalibrationHelper'#}

{#fun qlHestonModelHelper as hestonModelHelper {fromEnumQuantity `(Word, TimeUnit)'&, withSimpleType* `Calendar', `Double', `Double', withComplexType *`Quote', `YieldTermStructure', `YieldTermStructure', `CalibrationErrorType', preErrorCheck- `String' errorCheck*-} -> `BlackCalibrationHelper'#}

-- TODO add more parameters and more SwaptionHelper constructors
{#fun qlSwaptionHelper as swaptionHelper {fromEnumQuantity `(Word, TimeUnit)'&, fromEnumQuantity `(Word, TimeUnit)'&, withComplexType *`Quote', `IborIndex', fromEnumQuantity `(Word, TimeUnit)'&, withSimpleType* `DayCounter', withSimpleType* `DayCounter', `YieldTermStructure', `CalibrationErrorType', preErrorCheck- `String' errorCheck*-} -> `BlackCalibrationHelper'#}
