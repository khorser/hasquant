...
{#fun qlBondFunctionsAtmRate as atmRate {`Bond', withObject* `YieldTermStructure', withDay* `Day', `Double', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlBond as bond {fromIntegral `Word', withObject* `Calendar', withMaybeDay* `Maybe Day', withObject* `Leg', preErrorCheck- `String' errorCheck*-} -> `Bond'#}
...
{#fun qlBond1 as bond' {fromIntegral `Word', withObject* `Calendar', `Double', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', withObject* `Leg', preErrorCheck- `String' errorCheck*-} -> `Bond'#}

-- |Returns the maturity date of the bond
{#fun pure qlBondMaturityDate as maturityDate {`Bond'} -> `Maybe Day' toMaybeDay#}

-- |simple annual compounding coupon rates
{#fun qlFixedRateBond2 as fixedRateBondFromSchedule {fromIntegral `Word', `Double', withObject* `Schedule', withObjectArray* `[InterestRate]'&, `BusinessDayConvention', `Double', withMaybeDay* `Maybe Day', withObject* `Calendar', preErrorCheck- `String' errorCheck*-} -> `FixedRateBond'#}

-- |simple annual compounding coupon rates with internal schedule calculation
{#fun qlFixedRateBond1 as fixedRateBond {fromIntegral `Word', withObject* `Calendar', `Double', withDay* `Day', withDay* `Day', fromEnumQuantity `(Word, TimeUnit)'&, withDoubleArray* `[Double]'&, withObject* `DayCounter', `BusinessDayConvention', `BusinessDayConvention', `Double', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', `DateGenerationRule', `Bool', withObject* `Calendar', preErrorCheck- `String' errorCheck*-} -> `FixedRateBond'#}

-- |generic compounding and frequency InterestRate coupons
{#fun qlFixedRateBond as fixedRateBondFromSchedule' {fromIntegral `Word', `Double', withObject* `Schedule', withDoubleArray* `[Double]'&, withObject* `DayCounter', `BusinessDayConvention', `Double', withMaybeDay* `Maybe Day', withObject* `Calendar', preErrorCheck- `String' errorCheck*-} -> `FixedRateBond'#}

-- |zero-coupon bond
{#fun qlZeroCouponBond as zeroCouponBond {fromIntegral `Word', withObject* `Calendar', `Double', withDay* `Day', `BusinessDayConvention', `Double', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Bond'#}
...
{#fun qlBondCleanPrice1 as cleanPriceFromYield {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

-- |dirty price given a yield and settlement date
{#fun qlBondDirtyPrice1 as dirtyPriceFromYield {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlBondYield1 as yieldFromCleanPrice {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', `Double', fromIntegral `Word', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlBondFunctionsBasisPointValue1 as basisPointValue {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsBasisPointValue as basisPointValue' {`Bond', withObject* `InterestRate', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsBps1 as bpsFromYield' {`Bond', withObject* `InterestRate', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsBps2 as bpsFromYield {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsBps as bps {`Bond', withObject* `YieldTermStructure', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsCleanPrice2 as cleanPrice {`Bond', withObject* `YieldTermStructure', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsCleanPrice3 as cleanPrice' {`Bond', withObject* `YieldTermStructure', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsCleanPrice4 as cleanPriceFromYield' {`Bond', withObject* `InterestRate', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsConvexity1 as convexity {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsConvexity as convexity' {`Bond', withObject* `InterestRate', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsDuration1 as duration {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', `DurationType', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsDuration as duration' {`Bond', withObject* `InterestRate', `DurationType', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlBondFunctionsYield2 as yieldFromCleanPrice' {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', `Double', fromIntegral `Word', `Double', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsYieldValueBasisPoint1 as yieldValueBasisPoint {`Bond', `Double', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsYieldValueBasisPoint as yieldValueBasisPoint' {`Bond', withObject* `InterestRate', withDay* `Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlBondFunctionsZSpread as zSpread {`Bond', `Double', withObject* `YieldTermStructure', withObject* `DayCounter', `Compounding', `Frequency', withDay* `Day', `Double', fromIntegral `Word', `Double', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlFloatingRateBond1 as floatingRateBond' {fromIntegral `Word', `Double', withDay* `Day', withDay* `Day', `Frequency', withObject* `Calendar', withObject* `IborIndex', withObject* `DayCounter', `BusinessDayConvention', `BusinessDayConvention', fromIntegral `Word', withDoubleArray* `[Double]'&, withDoubleArray* `[Double]'&, withDoubleArray* `[Double]'&, withDoubleArray* `[Double]'&, `Bool', `Double', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', `DateGenerationRule', `Bool', preErrorCheck- `String' errorCheck*-} -> `Bond'#}
...
{#fun qlCallableFixedRateBond as callableFixedRateBond {fromIntegral `Word', `Double', withObject* `Schedule', withDoubleArray* `[Double]'&, withObject* `DayCounter', `BusinessDayConvention', `Double', withMaybeDay* `Maybe Day', withObjectArray* `[Callability]'&, preErrorCheck- `String' errorCheck*-} -> `CallableBond'#}

{#fun qlCallableZeroCouponBond as callableZeroCouponBond {fromIntegral `Word', `Double', withObject* `Calendar', withDay* `Day', withObject* `DayCounter', `BusinessDayConvention', `Double', withMaybeDay* `Maybe Day', withObjectArray* `[Callability]'&, preErrorCheck- `String' errorCheck*-} -> `CallableBond'#}

{#fun qlConvertibleFixedCouponBond as convertibleFixedCouponBond {withObject* `Exercise', `Double', withObjectArray* `[Dividend]'&, withObjectArray* `[Callability]'&, withObject* `Quote', withDay* `Day', fromIntegral `Word', withDoubleArray* `[Double]'&, withObject* `DayCounter', withObject* `Schedule', `Double', preErrorCheck- `String' errorCheck*-} -> `ConvertibleBond'#}

{#fun qlConvertibleFloatingRateBond as convertibleFloatingRateBond {withObject* `Exercise', `Double', withObjectArray* `[Dividend]'&, withObjectArray* `[Callability]'&, withObject* `Quote', withDay* `Day', fromIntegral `Word', withObject* `IborIndex', fromIntegral `Word', withDoubleArray* `[Double]'&, withObject* `DayCounter', withObject* `Schedule', `Double', preErrorCheck- `String' errorCheck*-} -> `ConvertibleBond'#}

{#fun qlConvertibleZeroCouponBond as convertibleZeroCouponBond {withObject* `Exercise', `Double', withObjectArray* `[Dividend]'&, withObjectArray* `[Callability]'&, withObject* `Quote', withDay* `Day', fromIntegral `Word', withObject* `DayCounter', withObject* `Schedule', `Double', preErrorCheck- `String' errorCheck*-} -> `ConvertibleBond'#}
