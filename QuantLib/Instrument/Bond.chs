...
{#fun qlBondYield as yield{withBond*`Bond',withDayCounter*`DayCounter',`Compounding',`Frequency'
  ,`Double' -- ^accuracy
...
{#fun qlBondYield1 as yieldFromCleanPrice{withBond*`Bond',`Double' -- ^cleanPrice
...
{#fun qlBondFunctionsYield2 as yieldFromCleanPrice'{withBond*`Bond',`Double' -- ^cleanPrice
  ,withDayCounter*`DayCounter',`Compounding',`Frequency',withDay*`Day' -- ^settlementDate
  ,`Double' --  ^accuracy
