...
{#fun qlCreditDefaultSwap as creditDefaultSwap{`ProtectionSide',`Double',`Double',withSchedule*`Schedule',`BusinessDayConvention',withDayCounter*`DayCounter',`Bool',`Bool',withMaybeDay*`Maybe Day',withClaim*`Claim',preErrorCheck-`String'errorCheck*-}->`CreditDefaultSwap'peekCreditDefaultSwap*#}
...
{#fun qlCreditDefaultSwap1 as creditDefaultSwap'{`ProtectionSide',`Double',`Double',`Double',withSchedule*`Schedule',`BusinessDayConvention',withDayCounter*`DayCounter',`Bool',`Bool',withMaybeDay*`Maybe Day',withMaybeDay*`Maybe Day',withClaim*`Claim',preErrorCheck-`String'errorCheck*-}->`CreditDefaultSwap'peekCreditDefaultSwap*#}
...
{#fun qlCdsOption as cdsOption{withCreditDefaultSwap*`CreditDefaultSwap',withExercise*`Exercise',`Bool',preErrorCheck-`String'errorCheck*-}->`CdsOption'peekCdsOption*#}

{#fun qlCdsOptionImpliedVolatility as impliedVolatility{withCdsOption*`CdsOption',`Double',withYieldTermStructure*`YieldTermStructure',withDefaultProbabilityTermStructure*`DefaultProbabilityTermStructure',`Double',`Double',fromIntegral`Word',`Double',`Double',preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCreditDefaultSwapConventionalSpread as conventionalSpread{withCreditDefaultSwap*`CreditDefaultSwap',`Double',withYieldTermStructure*`YieldTermStructure',withDayCounter*`DayCounter',preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCreditDefaultSwapCoupons as coupons{withCreditDefaultSwap*`CreditDefaultSwap',preErrorCheck-`String'errorCheck*-}->`Leg'peekLeg*#}

{#fun qlCreditDefaultSwapDefaultLegNPV as defaultLegNPV{withCreditDefaultSwap*`CreditDefaultSwap',preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCreditDefaultSwapFairUpfront as fairUpfront{withCreditDefaultSwap*`CreditDefaultSwap',preErrorCheck-`String'errorCheck*-}->`Double'#}

-- |Implied hazard rate calculation.
-- This method performs the calculation with the instrument characteristics. It will coincide with the ISDA calculation if your object has the standard characteristics. Notably: The calendar should have no bank holidays, just weekends.The yield curve should be LIBOR piecewise constant in fwd rates, with a discount factor of 1 on the calculation date, which coincides with the trade date.Convention should be Following for yield curve and contract cashflows.The CDS should pay accrued and mature on standard IMM dates, settle on trade date +1 and upfront settle on trade date +3.
{#fun qlCreditDefaultSwapImpliedHazardRate as impliedHazardRate{withCreditDefaultSwap*`CreditDefaultSwap',`Double',withYieldTermStructure*`YieldTermStructure',withDayCounter*`DayCounter',`Double',`Double',preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCreditDefaultSwapUpfrontNPV as upfrontNPV{withCreditDefaultSwap*`CreditDefaultSwap',preErrorCheck-`String'errorCheck*-}->`Double'#}
