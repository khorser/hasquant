...
{#fun qlSettingsSetEvaluationDate as setEvaluationDate {marshalDay'* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `()' #}
...
{#fun qlSettingsIncludeTodaysCashFlows as includeTodaysCashFlows {} -> `Maybe Bool' unmarshalBool' #}

{#fun qlSettingsSetIncludeTodaysCashFlows as setIncludeTodaysCashFlows {marshalBool' `Maybe Bool'} -> `()' #}
