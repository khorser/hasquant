...
{#fun qlAnalyticBarrierEngine as analyticBarrierEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlAnalyticTwoAssetBarrierEngine as analyticTwoAssetBarrierEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1' -- ^process1
  ,withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2' -- ^process2
...
{#fun qlAnalyticSoftBarrierEngine as analyticSoftBarrierEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for simple chooser options
{#fun qlAnalyticSimpleChooserEngine as analyticSimpleChooserEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |Analytic Black-Scholes engine for a 'complexChooserOption'. Both alternatives must have European exercise.
{#fun qlAnalyticComplexChooserEngine as analyticComplexChooserEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs' -- ^process
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for two-asset correlation options
{#fun qlAnalyticTwoAssetCorrelationEngine as analyticTwoAssetCorrelationEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1' -- ^process1
  ,withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2' -- ^process2
...
{#fun qlAnalyticEuropeanMargrabeEngine as analyticEuropeanMargrabeEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1' -- ^process1
  ,withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2' -- ^process2
  ,`Double' -- ^correlation
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlAnalyticAmericanMargrabeEngine as analyticAmericanMargrabeEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1' -- ^process1
  ,withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2' -- ^process2
  ,`Double' -- ^correlation
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for writer-extensible options
{#fun qlAnalyticWriterExtensibleOptionEngine as analyticWriterExtensibleOptionEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |Analytic Black-Scholes engine for a 'holderExtensibleOption'. The original option must have European exercise.
{#fun qlAnalyticHolderExtensibleOptionEngine as analyticHolderExtensibleOptionEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs' -- ^process
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for partial-time barrier options
{#fun qlAnalyticPartialTimeBarrierOptionEngine as analyticPartialTimeBarrierOptionEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for American binary barrier options (cash-or-nothing/asset-or-nothing)
{#fun qlAnalyticBinaryBarrierEngine as analyticBinaryBarrierEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlBinomialBarrierEngine as binomialBarrierEngine{`BinomialTree',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromIntegral`Word' -- ^timeSteps
...
{#fun qlAnalyticDoubleBarrierEngine as analyticDoubleBarrierEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromIntegral`Int' -- ^series
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlBinomialDoubleBarrierEngine as binomialDoubleBarrierEngine{`BinomialTree',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromIntegral`Word' -- ^timeSteps
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |Monte Carlo pricing engine for double-barrier options
{#fun qlMCDoubleBarrierEngine as mcDoubleBarrierEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
...
{#fun qlAnalyticCliquetEngine as analyticCliquetEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for compound options
{#fun qlAnalyticCompoundOptionEngine as analyticCompoundOptionEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for European continuous fixed-strike lookback options
{#fun qlAnalyticContinuousFixedLookbackEngine as analyticContinuousFixedLookbackEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for European continuous floating-strike lookback options
{#fun qlAnalyticContinuousFloatingLookbackEngine as analyticContinuousFloatingLookbackEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for European continuous partial-time floating-strike lookback options
{#fun qlAnalyticContinuousPartialFloatingLookbackEngine as analyticContinuousPartialFloatingLookbackEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for European continuous partial-time fixed-strike lookback options
{#fun qlAnalyticContinuousPartialFixedLookbackEngine as analyticContinuousPartialFixedLookbackEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for European continuous geometric average-price Asian options
{#fun qlAnalyticContinuousGeometricAveragePriceAsianEngine as analyticContinuousGeometricAveragePriceAsianEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlMCLookbackFixedEngine as mcLookbackFixedEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
-- @timeSteps@\/@timeStepsPerYear@ must be given; the other must be 'Nothing'.
{#fun qlMCLookbackFloatingEngine as mcLookbackFloatingEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlMCLookbackPartialFixedEngine as mcLookbackPartialFixedEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlMCLookbackPartialFloatingEngine as mcLookbackPartialFloatingEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlAnalyticDigitalAmericanEngine as analyticDigitalAmericanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for American knock-out digital (cash-or-nothing/asset-or-nothing) options
{#fun qlAnalyticDigitalAmericanKOEngine as analyticDigitalAmericanKoEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for European discrete geometric average-price Asian options
{#fun qlAnalyticDiscreteGeometricAveragePriceAsianEngine as analyticDiscreteGeometricAveragePriceAsianEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for European discrete geometric average-strike Asian options
{#fun qlAnalyticDiscreteGeometricAverageStrikeAsianEngine as analyticDiscreteGeometricAverageStrikeAsianEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |Turnbull-Wakeman moment-matching pricing engine for discrete arithmetic average-price\/-strike Asian options
{#fun qlTurnbullWakemanAsianEngine as turnbullWakemanAsianEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic pricing engine for European options with discrete dividends
{#fun qlAnalyticDividendEuropeanEngine as analyticDividendEuropeanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',withDividendArray*`[Dividend]'&,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |analytic Black-Scholes pricing engine for European options
{#fun qlAnalyticEuropeanEngine as analyticEuropeanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
...
{#fun qlAnalyticPerformanceEngine as analyticPerformanceEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlForwardEuropeanEngine as forwardEuropeanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlForwardBaroneAdesiWhaleyEngine as forwardBaroneAdesiWhaleyEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlForwardBjerksundStenslandEngine as forwardBjerksundStenslandEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlForwardFdBlackScholesVanillaEngine as forwardFdBlackScholesVanillaEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |Monte Carlo pricing engine for forward-starting European options under a Black-Scholes process
{#fun qlMCForwardEuropeanBSEngine1 as mcForwardEuropeanBsEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlQuantoEuropeanEngine as quantoEuropeanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
...
{#fun qlQuantoForwardEuropeanEngine as quantoForwardEuropeanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
  ,withYieldTermStructure*`GenYieldTermStructure y' -- ^foreignRiskFreeRate
  ,withBlackVolTermStructure*`GenBlackVolTermStructure bv' -- ^exchangeRateVolatility
  ,withQuote*`GenQuote q' -- ^correlation
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlQuantoForwardPerformanceEuropeanEngine as quantoForwardPerformanceEuropeanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
  ,withYieldTermStructure*`GenYieldTermStructure y' -- ^foreignRiskFreeRate
  ,withBlackVolTermStructure*`GenBlackVolTermStructure bv' -- ^exchangeRateVolatility
  ,withQuote*`GenQuote q' -- ^correlation
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlQuantoBarrierEngine as quantoBarrierEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
  ,withYieldTermStructure*`GenYieldTermStructure y' -- ^foreignRiskFreeRate
  ,withBlackVolTermStructure*`GenBlackVolTermStructure bv' -- ^exchangeRateVolatility
  ,withQuote*`GenQuote q' -- ^correlation
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlQuantoDoubleBarrierEngine as quantoDoubleBarrierEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
  ,withYieldTermStructure*`GenYieldTermStructure y' -- ^foreignRiskFreeRate
  ,withBlackVolTermStructure*`GenBlackVolTermStructure bv' -- ^exchangeRateVolatility
  ,withQuote*`GenQuote q' -- ^correlation
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlAnalyticBSMHullWhiteEngine as analyticBsmHullWhiteEngine{`Double',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',withHullWhite*`HullWhite',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlFFTVanillaEngine as fftVanillaEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',`Double' -- ^logStrikeSpacing
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlBaroneAdesiWhaleyApproximationEngine as baroneAdesiWhaleyApproximationEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlBjerksundStenslandApproximationEngine as bjerksundStenslandApproximationEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlQdPlusAmericanEngine as qdPlusAmericanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
...
{#fun qlQdFpAmericanEngine as qdFpAmericanEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
...
{#fun qlContinuousArithmeticAsianVecerEngine as continuousArithmeticAsianVecerEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
...
{#fun qlIntegralEngine as integralEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlJuQuadraticApproximationEngine as juQuadraticApproximationEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlReplicatingVarianceSwapEngine as replicatingVarianceSwapEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',`Double' -- ^dk
...
{#fun qlStulzEngine as stulzEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2',`Double' -- ^correlation
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |Bjerksund-Stensland (2014) closed-form pricing engine for a spread option on two futures
{#fun qlBjerksundStenslandSpreadEngine as bjerksundStenslandSpreadEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2',`Double' -- ^correlation
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |Chi-Fai Lo (2015) operator-splitting-approximation pricing engine for a spread option
{#fun qlOperatorSplittingSpreadEngine as operatorSplittingSpreadEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2',`Double' -- ^correlation
...
{#fun qlPearsonSpreadEngine as pearsonSpreadEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2',`Double' -- ^correlation
...
{#fun qlGaussianCopulaSpreadEngine as gaussianCopulaSpreadEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2',`Double' -- ^correlation
...
choiBasketEngine :: NonEmpty (GenGeneralizedBlackScholesProcess gbs) -> Matrix Double -- ^correlation matrix rho
...
{#fun qlChoiBasketEngine{withGeneralizedBlackScholesProcessArray*`[GenGeneralizedBlackScholesProcess gbs]'&
...
dengLiZhouBasketEngine :: NonEmpty (GenGeneralizedBlackScholesProcess gbs) -> Matrix Double -- ^correlation matrix rho
  -> IO PricingEngine
dengLiZhouBasketEngine ps (Matrix mr mc md) = qlDengLiZhouBasketEngine (toList ps) mr mc md
{#fun qlDengLiZhouBasketEngine{withGeneralizedBlackScholesProcessArray*`[GenGeneralizedBlackScholesProcess gbs]'&
  ,fromIntegral`Word',fromIntegral`Word',withDoubleArrayRaw*`[Double]'
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |pricing engine for a basket where all underlyings are driven by one stochastic factor
singleFactorBsmBasketEngine :: NonEmpty (GenGeneralizedBlackScholesProcess gbs)
  -> Double -- ^xTol, upstream default: @1e4*QL_EPSILON@
  -> IO PricingEngine
singleFactorBsmBasketEngine ps = qlSingleFactorBsmBasketEngine (toList ps)
{#fun qlSingleFactorBsmBasketEngine{withGeneralizedBlackScholesProcessArray*`[GenGeneralizedBlackScholesProcess gbs]'&
  ,`Double' -- ^xTol
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}
...
{#fun qlFd2dBlackScholesVanillaEngine as fd2dBlackScholesVanillaEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs1',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs2',`Double' -- ^correlation
...
-- per-axis grid size
fdndimBlackScholesVanillaEngineAxisGrids :: NonEmpty (GenGeneralizedBlackScholesProcess gbs) -> Matrix Double -- ^correlation matrix rho
...
{#fun qlFdndimBlackScholesVanillaEngine{withGeneralizedBlackScholesProcessArray*`[GenGeneralizedBlackScholesProcess gbs]'&
  ,fromIntegral`Word',fromIntegral`Word',withDoubleArrayRaw*`[Double]'
  ,withIntArray*`[Word]'&
...
fdndimBlackScholesVanillaEngineUniformGrid :: NonEmpty (GenGeneralizedBlackScholesProcess gbs) -> Matrix Double -- ^correlation matrix rho
  -> Word -- ^xGrid
  -> Word -- ^tGrid, upstream default: 50
  -> Word -- ^dampingSteps, upstream default: 0
  -> FdmScheme -- ^schemeDesc, upstream default: 'Douglas'
...
{#fun qlFdndimBlackScholesVanillaEngine1{withGeneralizedBlackScholesProcessArray*`[GenGeneralizedBlackScholesProcess gbs]'&
  ,fromIntegral`Word',fromIntegral`Word',withDoubleArrayRaw*`[Double]'
...
fdndimBlackScholesVanillaEngine :: NonEmpty (GenGeneralizedBlackScholesProcess gbs) -> Matrix Double
...
{#fun qlFdBlackScholesBarrierEngine as fdBlackScholesBarrierEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromIntegral`Word' -- ^tGrid
  ,fromIntegral`Word' -- ^xGrid
  ,fromIntegral`Word' -- ^dampingSteps
  ,withFdmSchemeDesc*`FdmScheme'
  ,`Bool' -- ^localVol
...
{#fun qlMCAmericanEngine1 as mcAmericanEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word', -- ^timeSteps
  fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^antitheticVariate
  ,`Bool' -- ^controlVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlMCBarrierEngine1 as mcBarrierEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlMCDigitalEngine1 as mcDigitalEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word', -- ^timeStepsPerYear
  `Bool', -- ^brownianBridge
  `Bool', -- ^antitheticVariate
  fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlMCDiscreteArithmeticAPEngine1 as mcDiscreteArithmeticApEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,`Bool' -- ^controlVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
  ,fromMaybeDouble`Maybe Double' -- ^requiredTolerance
...
{#fun qlMCDiscreteArithmeticASEngine1 as mcDiscreteArithmeticAsEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
  ,fromMaybeDouble`Maybe Double' -- ^requiredTolerance
  ,fromMaybeInt`Maybe Word' -- ^maxSamples
...
{#fun qlMCDiscreteGeometricAPEngine1 as mcDiscreteGeometricApEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
  ,fromMaybeDouble`Maybe Double' -- ^requiredTolerance
  ,fromMaybeInt`Maybe Word' -- ^maxSamples
...
{#fun qlMCEuropeanEngine1 as mcEuropeanEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlMCPerformanceEngine1 as mcPerformanceEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
  ,fromMaybeDouble`Maybe Double' -- ^requiredTolerance
  ,fromMaybeInt`Maybe Word' -- ^maxSamples
...
{#fun qlMCVarianceSwapEngine1 as mcVarianceSwapEngine{`RngTrait',`StatisticsTrait',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromMaybeInt`Maybe Word' -- ^timeSteps
  ,fromMaybeInt`Maybe Word' -- ^timeStepsPerYear
  ,`Bool' -- ^brownianBridge
  ,`Bool' -- ^antitheticVariate
  ,fromMaybeInt`Maybe Word' -- ^requiredSamples
...
{#fun qlBinomialVanillaEngine as binomialVanillaEngine{`BinomialTree',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromIntegral`Word' -- ^timeSteps
  ,preErrorCheck-`String'errorCheck*-}->`PricingEngine'peekPricingEngine*#}

-- |finite-differences Black-Scholes pricing engine for discrete-averaging Asian options
{#fun qlFdBlackScholesAsianEngine as fdBlackScholesAsianEngine{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromIntegral`Word' -- ^tGrid
  ,fromIntegral`Word' -- ^xGrid
...
{#fun qlFdBlackScholesVanillaEngine as fdBlackScholesVanillaEngineNoDividends{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',fromIntegral`Word' -- ^timeSteps
...
{#fun qlFdBlackScholesVanillaEngine1 as fdBlackScholesVanillaEngineWithDividends{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',withDividendArray*`[Dividend]'&
  ,fromIntegral`Word' -- ^timeSteps
  ,fromIntegral`Word' -- ^gridPoints
  ,fromIntegral`Word' -- ^timeDependent
  ,withFdmSchemeDesc*`FdmScheme'
...
fdBlackScholesVanillaEngine :: GenGeneralizedBlackScholesProcess gbs -> [Dividend] -> Word -> Word -> Word
...
{#fun qlFdBlackScholesVanillaEngine2 as fdBlackScholesVanillaEngineQuantoNoDividends{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',withMaybeFdmQuantoHelper*`Maybe FdmQuantoHelper'
  ,fromIntegral`Word' -- ^timeSteps
  ,fromIntegral`Word' -- ^gridPoints
  ,fromIntegral`Word' -- ^timeDependent
  ,withFdmSchemeDesc*`FdmScheme'
...
{#fun qlFdBlackScholesVanillaEngine3 as fdBlackScholesVanillaEngineQuantoWithDividends{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs',withDividendArray*`[Dividend]'&,withMaybeFdmQuantoHelper*`Maybe FdmQuantoHelper'
  ,fromIntegral`Word' -- ^timeSteps
  ,fromIntegral`Word' -- ^gridPoints
  ,fromIntegral`Word' -- ^timeDependent
  ,withFdmSchemeDesc*`FdmScheme'
...
fdBlackScholesVanillaEngineQuanto :: GenGeneralizedBlackScholesProcess gbs -> [Dividend]
...
{#fun qlFdBlackScholesShoutEngine as fdBlackScholesShoutEngineNoDividends{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs' -- ^process
  ,fromIntegral`Word' -- ^tGrid
  ,fromIntegral`Word' -- ^xGrid
  ,fromIntegral`Word' -- ^dampingSteps
  ,withFdmSchemeDesc*`FdmScheme' -- ^schemeDesc
...
{#fun qlFdBlackScholesShoutEngine1 as fdBlackScholesShoutEngineWithDividends{withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs' -- ^process
  ,withDividendArray*`[Dividend]'& -- ^dividends
  ,fromIntegral`Word' -- ^tGrid
  ,fromIntegral`Word' -- ^xGrid
  ,fromIntegral`Word' -- ^dampingSteps
...
fdBlackScholesShoutEngine :: GenGeneralizedBlackScholesProcess gbs -> [Dividend] -> Word -> Word
...
{#fun qlBinomialConvertibleEngine as binomialConvertibleEngine{`BinomialTree',withGeneralizedBlackScholesProcess*`GenGeneralizedBlackScholesProcess gbs'
  ,fromIntegral`Word' -- ^timeSteps
