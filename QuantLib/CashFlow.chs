...
{#fun qlCashFlowsDuration as duration {`Leg', withObject* `InterestRate', `DurationType', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsBasisPointValue1 as basisPointValue {`Leg', `Double' , withObject* `DayCounter' , `Compounding' , `Frequency' , `Bool' , withMaybeDay* `Maybe Day' , withMaybeDay* `Maybe Day' , preErrorCheck- `String' errorCheck*-} -> `Double'#}

-- |Basis-point value.
-- Obtained by setting dy = 0.0001 in the 2nd-order Taylor series expansion.
{#fun qlCashFlowsBasisPointValue as basisPointValue' {`Leg' , withObject* `InterestRate' , `Bool' , withMaybeDay* `Maybe Day' , withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsBps1 as bpsFromYield' {`Leg' , withObject* `InterestRate' , `Bool' , withMaybeDay* `Maybe Day' , withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlCashFlowsBps2 as bpsFromYield {`Leg' , `Double' , withObject* `DayCounter' , `Compounding' , `Frequency' , `Bool' , withMaybeDay* `Maybe Day' , withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlCashFlowsConvexity1 as convexity {`Leg', `Double', withObject* `DayCounter', `Compounding', `Frequency', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsConvexity as convexity' {`Leg', withObject* `InterestRate', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlCashFlowsDuration1 as duration' {`Leg', `Double', withObject* `DayCounter', `Compounding', `Frequency', `DurationType', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsNpv1 as npvFromYield' {`Leg', withObject* `InterestRate', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlCashFlowsNpv2 as npvFromYield {`Leg', `Double', withObject* `DayCounter', `Compounding', `Frequency', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsAtmRate as atmRate {`Leg', withObject* `YieldTermStructure', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', `Double', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsBps as bps {`Leg', withObject* `YieldTermStructure', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsNpv3 as npv' {`Leg', withObject* `YieldTermStructure', `Double', withObject* `DayCounter', `Compounding', `Frequency', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

-- |NPV of the cash flows.
-- The NPV is the sum of the cash flows, each discounted according to the given term structure.
{#fun qlCashFlowsNpv as npv {`Leg', withObject* `YieldTermStructure', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}

-- |NPV and BPS of the cash flows.
-- The NPV and BPS of the cash flows calculated together for performance reason
{#fun qlCashFlowsNpvbps as npvbps {`Leg', withObject* `YieldTermStructure', `Bool', withDay* `Day', withDay* `Day', prePtr- `Double' peekDouble*, prePtr- `Double' peekDouble*, preErrorCheck- `String' errorCheck*-} -> `()'#}

-- |implied Z-spread.
{#fun qlCashFlowsZSpread as zSpread {`Leg', `Double', withObject* `YieldTermStructure', withObject* `DayCounter', `Compounding', `Frequency', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', `Double', fromIntegral `Word', `Double', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsYield as yield {`Leg', `Double', withObject* `DayCounter', `Compounding', `Frequency', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', `Double', fromIntegral `Word', `Double', preErrorCheck- `String' errorCheck*-} -> `Double'#}

{#fun qlCashFlowsYieldValueBasisPoint1 as yieldValueBasisPoint {`Leg', `Double', withObject* `DayCounter', `Compounding', `Frequency', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
...
{#fun qlCashFlowsYieldValueBasisPoint as yieldValueBasisPoint' {`Leg', withObject* `InterestRate', `Bool', withMaybeDay* `Maybe Day', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `Double'#}
