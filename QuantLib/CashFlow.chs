...
{#fun qlNextCashFlows as nextCashFlows{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Leg'peekLeg*#}

-- |return cashflows that occurred before /settlementDate/
{#fun qlPreviousCashFlows as previousCashFlows{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Leg'peekLeg*#}

{#fun qlLegCashFlows{withLeg*`GenLeg a', fromMaybeBool`Maybe Bool', withMaybeDay*`Maybe Day', preArray-`[Double]'&peekDoubleArray*, preArray-`[Day]'&peekDayArray*, preArray-`[Bool]'&peekBoolArray*, preErrorCheck-`String'errorCheck*-}->`()'#}
...
{#fun qlCashFlowsDuration as duration{withLeg*`GenLeg a', withInterestRate*`InterestRate',`DurationType',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsAccrualDays as accrualDays{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Int'#}

{#fun qlCashFlowsAccrualEndDate as accrualEndDate{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Maybe Day' toMaybeDay#}

{#fun qlCashFlowsAccrualPeriod as accrualPeriod{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsAccrualStartDate as accrualStartDate{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Maybe Day' toMaybeDay#}

{#fun qlCashFlowsAccruedAmount as accruedAmount{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsAccruedDays as accruedDays{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Int'#}

{#fun qlCashFlowsAccruedPeriod as accruedPeriod{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsBasisPointValue1 as basisPointValue{withLeg*`GenLeg a',`Double', withDayCounter*`DayCounter',`Compounding',`Frequency',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

-- |Basis-point value.
-- Obtained by setting dy = 0.0001 in the 2nd-order Taylor series expansion.
{#fun qlCashFlowsBasisPointValue as basisPointValue'{withLeg*`GenLeg a', withInterestRate*`InterestRate',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCashFlowsBps1 as bpsFromYield'{withLeg*`GenLeg a', withInterestRate*`InterestRate',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsBps2 as bpsFromYield{withLeg*`GenLeg a',`Double', withDayCounter*`DayCounter',`Compounding',`Frequency',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsConvexity1 as convexity{withLeg*`GenLeg a',`Double', withDayCounter*`DayCounter',`Compounding',`Frequency',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCashFlowsConvexity as convexity'{withLeg*`GenLeg a', withInterestRate*`InterestRate',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsDuration1 as duration'{withLeg*`GenLeg a',`Double', withDayCounter*`DayCounter',`Compounding',`Frequency',`DurationType',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsIsExpired as isExpired{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Bool'#}

{#fun qlCashFlowsMaturityDate as maturityDate{withLeg*`GenLeg a', preErrorCheck-`String'errorCheck*-}->`Day'toDay#}

{#fun qlCashFlowsNextCashFlowAmount as nextCashFlowAmount{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsNextCashFlowDate as nextCashFlowDate{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`(Maybe Day)' toMaybeDay#}

{#fun qlCashFlowsNextCouponRate as nextCouponRate{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsNominal as nominal{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCashFlowsNpv1 as npvFromYield'{withLeg*`GenLeg a', withInterestRate*`InterestRate',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsNpv2 as npvFromYield{withLeg*`GenLeg a',`Double', withDayCounter*`DayCounter',`Compounding',`Frequency',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCashFlowsPreviousCashFlowDate as previousCashFlowDate{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Maybe Day' toMaybeDay#}

{#fun qlCashFlowsPreviousCouponRate as previousCouponRate{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsReferencePeriodEnd as referencePeriodEnd{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Maybe Day' toMaybeDay#}

{#fun qlCashFlowsReferencePeriodStart as referencePeriodStart{withLeg*`GenLeg a',`Bool', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Maybe Day' toMaybeDay#}
...
{#fun qlCashFlowsYield as yield{withLeg*`GenLeg a',`Double', withDayCounter*`DayCounter',`Compounding',`Frequency',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day',`Double', fromIntegral`Word',`Double', preErrorCheck-`String'errorCheck*-}->`Double'#}

{#fun qlCashFlowsYieldValueBasisPoint1 as yieldValueBasisPoint{withLeg*`GenLeg a',`Double', withDayCounter*`DayCounter',`Compounding',`Frequency',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}
...
{#fun qlCashFlowsYieldValueBasisPoint as yieldValueBasisPoint'{withLeg*`GenLeg a', withInterestRate*`InterestRate',`Bool', withMaybeDay*`Maybe Day', withMaybeDay*`Maybe Day', preErrorCheck-`String'errorCheck*-}->`Double'#}
