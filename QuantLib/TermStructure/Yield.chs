...
{#fun qlDepositRateHelper1 as depositRateHelper' {withQuote*`Quote', `IborIndex', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlDepositRateHelper as depositRateHelper {withQuote*`Quote', fromEnumQuantity `(Int, TimeUnit)'&, fromIntegral `Word', withCalendar*`Calendar', `BusinessDayConvention', `Bool', withDayCounter*`DayCounter', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlFixedRateBondHelper as fixedRateBondHelper {withQuote*`Quote', fromIntegral `Word', `Double', withSchedule*`Schedule', withDoubleArray* `[Double]'&, withDayCounter*`DayCounter', `BusinessDayConvention', `Double', withMaybeDay* `Maybe Day', preErrorCheck- `String' errorCheck*-} -> `BondHelper'#}
...
{#fun qlSwapRateHelper1 as swapRateHelper' {withQuote*`Quote', fromEnumQuantity `(Int, TimeUnit)'&, withCalendar*`Calendar', `Frequency', `BusinessDayConvention', withDayCounter*`DayCounter', `IborIndex', withMaybeQuote*`Maybe Quote', fromEnumQuantity `(Int, TimeUnit)'&, withMaybeObject* `Maybe YieldTermStructure', preErrorCheck- `String' errorCheck*-} -> `SwapRateHelper'#}

{#fun qlFlatForward as flatForward {withDay* `Day', withQuote*`Quote', withDayCounter*`DayCounter', `Compounding', `Frequency', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}

{#fun qlFlatForward1 as flatForward' {fromIntegral `Word', withCalendar*`Calendar', withQuote*`Quote', withDayCounter*`DayCounter', `Compounding', `Frequency', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}
...
{#fun qlFraRateHelper as fraRateHelper {withQuote*`Quote', fromIntegral `Word', fromIntegral `Word', fromIntegral `Word', withCalendar*`Calendar', `BusinessDayConvention', `Bool', withDayCounter*`DayCounter', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}
...
{#fun qlBondHelper as bondHelper {withQuote*`Quote', withObject* `Bond', preErrorCheck- `String' errorCheck*-} -> `BondHelper'#}

{#fun qlOISRateHelper as oisRateHelper {fromIntegral `Word', fromEnumQuantity `(Int, TimeUnit)'&, withQuote*`Quote', `OvernightIborIndex', withMaybeObject* `Maybe YieldTermStructure', preErrorCheck- `String' errorCheck*-} -> `OISRateHelper'#}

{#fun qlSwapRateHelper as swapRateHelper {withQuote*`Quote', `SwapIndex', withMaybeQuote*`Maybe Quote', fromEnumQuantity `(Int, TimeUnit)'&, withMaybeObject* `Maybe YieldTermStructure', preErrorCheck- `String' errorCheck*-} -> `SwapRateHelper'#}

{#fun qlForwardSpreadedTermStructure as forwardSpreadedTermStructure {`YieldTermStructure', withQuote*`Quote', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}

{#fun qlZeroSpreadedTermStructure as zeroSpreadedTermStructure {`YieldTermStructure', withQuote*`Quote', `Compounding', `Frequency', withDayCounter*`DayCounter', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}

{#fun qlBMASwapRateHelper as bmaSwapRateHelper {withQuote*`Quote', fromEnumQuantity `(Int, TimeUnit)'&, fromIntegral `Word', withCalendar*`Calendar', fromEnumQuantity `(Int, TimeUnit)'&, `BusinessDayConvention', withDayCounter*`DayCounter', `BMAIndex', `IborIndex', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlDatedOISRateHelper as datedOISRateHelper {withDay* `Day', withDay* `Day', withQuote*`Quote', `OvernightIborIndex', withMaybeObject* `Maybe YieldTermStructure', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlFraRateHelper1 as fraIborRateHelper' {withQuote*`Quote', fromIntegral `Word', `IborIndex', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlFraRateHelper2 as fraRateHelper' {withQuote*`Quote', fromEnumQuantity `(Int, TimeUnit)'&, fromIntegral `Word', fromIntegral `Word', withCalendar*`Calendar', `BusinessDayConvention', `Bool', withDayCounter*`DayCounter', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlFraRateHelper3 as fraIborRateHelper {withQuote*`Quote', fromEnumQuantity `(Int, TimeUnit)'&, `IborIndex', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlFuturesRateHelper1 as futuresRateHelper' {withQuote*`Quote', withDay* `Day', withDay* `Day', withDayCounter*`DayCounter', withMaybeQuote*`Maybe Quote', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlFuturesRateHelper2 as futuresIborRateHelper {withQuote*`Quote', withDay* `Day', `IborIndex', withMaybeQuote*`Maybe Quote', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}

{#fun qlFuturesRateHelper as futuresRateHelper {withQuote*`Quote', withDay* `Day', fromIntegral `Word', withCalendar*`Calendar', `BusinessDayConvention', `Bool', withDayCounter*`DayCounter', withMaybeQuote*`Maybe Quote', preErrorCheck- `String' errorCheck*-} -> `RateHelper'#}
...
{#fun qlPiecewiseZeroSpreadedTermStructure {`YieldTermStructure', withQuoteArray*`[Quote]'&, withDayArray* `[Day]'&, `Compounding', `Frequency', withDayCounter*`DayCounter', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}
...
{#fun qlPiecewiseYieldCurve {withDay* `Day', withObjectArray* `[RateHelper]'&, withDayCounter*`DayCounter', withQuoteArray*`[Quote]'&, withDayArray* `[Day]'&, `BootstrapTrait', `Int', `Int', `Int', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}
...
{#fun qlPiecewiseYieldCurve1 {fromIntegral `Word', withCalendar*`Calendar', withObjectArray* `[RateHelper]'&, withDayCounter*`DayCounter', withQuoteArray*`[Quote]'&, withDayArray* `[Day]'&, `BootstrapTrait', `Int', `Int', `Int', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}
...
{#fun qlInterpolatedDiscountCurve {withDoubleArray* `[Double]'&, withDayArray* `[Day]'&, withDayCounter*`DayCounter', withCalendar*`Calendar', withQuoteArray*`[Quote]'&, withDayArray* `[Day]'&, `Int', `Int', `Int', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}
...
{#fun qlInterpolatedForwardCurve {withDoubleArray* `[Double]'&, withDayArray* `[Day]'&, withDayCounter*`DayCounter', withCalendar*`Calendar', withQuoteArray*`[Quote]'&, withDayArray* `[Day]'&, `Int', `Int', `Int', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}
...
{#fun qlInterpolatedZeroCurve {withDoubleArray* `[Double]'&, withDayArray* `[Day]'&, withDayCounter*`DayCounter', withCalendar*`Calendar', withQuoteArray*`[Quote]'&, withDayArray* `[Day]'&, `Int', `Int', `Int', preErrorCheck- `String' errorCheck*-} -> `YieldTermStructure'#}
