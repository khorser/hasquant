...
- Use QuantLib Handles/RelinkableHandle for *quotes* and volatility structures to support native QuantLib semantics (done for yield curves: see `relinkableYieldTermStructure`/`linkTo`)
