...
using QlCoupon = shared_ptr<Coupon>;
...
QL_TRACE_NAME(ExtendedBlackVarianceCurve)
...
QL_TRACE_NAME(QlConstNotionalCrossCurrencySwap)
QL_TRACE_NAME(QlConstNotionalCrossCurrencyBasisSwap)
QL_TRACE_NAME(QlConstNotionalCrossCurrencyFixedVsFloatingSwap)
...
QL_TRACE_NAME(QlCPICoupon)
QL_TRACE_NAME(QlCPICouponPricer)
...
QL_TRACE_NAME(QlRangeAccrualFloatersCoupon)
QL_TRACE_NAME(QlForward)
QL_TRACE_NAME(QlForwardRateAgreement)
QL_TRACE_NAME(QlFxForward)
QL_TRACE_NAME(QlG2)
QL_TRACE_NAME(QlG2Process)
QL_TRACE_NAME(QlG2ForwardProcess)
...
QL_TRACE_NAME(QlIrregularSwap)
QL_TRACE_NAME(QlIrregularSwaption)
...
QL_TRACE_NAME(QlRebatedExercise)
...
QL_TRACE_NAME(QlRelinkableQuote)
...
QL_TRACE_NAME(QlRelinkableSwaptionVolatilityStructure)
...
QL_TRACE_NAME(SABRVolTermStructure)
