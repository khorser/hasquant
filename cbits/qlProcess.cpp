...
ext::shared_ptr<StochasticProcess::discretization> createDiscretization(int n) {
  switch (n) {
...
QuantLib::ext::shared_ptr<StochasticProcess1D::discretization> createDiscretization1D(int n) {
  switch (n) {
  case hasquant::EulerDiscretization:
